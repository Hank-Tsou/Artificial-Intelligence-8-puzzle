...
public class Solver2 {
	...
	public Solver2(Board initial) {
		...
		exploredList.put(CharToString(initial.BoardArray()), initial.h2() + parent.moves);
		...
		while(!parent.board.isGoal()) {
			...
			exploredList.put(CharToString(parent.board.BoardArray()), parent.board.h2() + parent.moves);	
		}
	...
	private class Priority implements Comparator<Node> {
        public int compare(Node n1, Node n2) {
            int num1 = n1.board.h2() + n1.moves;
            int num2 = n2.board.h2() + n2.moves;
            return num1 - num2;
        }
    }
}